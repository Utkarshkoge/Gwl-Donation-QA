  ...
  return /* @__PURE__ */ jsxs(Page, {
    ...
    children: [/* @__PURE__ */ jsxs(Layout, {
      ...
      primaryAction: {
        ...
        destructive: true,
        loading: isSubmitting2 && ((_f = fetcher.formData) == null ? void 0 : _f.get("_action")) === "cancel",
        onAction: () => {
          handleAction("cancel");
