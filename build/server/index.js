...
async function syncOneDayConfig(shop, dailyPlanId2, sellingPlanGroupId) {
  await prisma.recurringDonationConfig.update({
    where: { shop },
    data: { dailyPlanId: dailyPlanId2 }
  });
  await prisma.oneDayDonationConfig.upsert({
    where: { shop },
    update: {
      isActive: true,
      dailyPlanId: dailyPlanId2
    },
    create: {
      shop,
      isActive: true,
  ...
  console.log(`[OneDaySubscription] Config saved for ${shop}. Daily Plan: ${dailyPlanId2}`);
}
...
const app_onedaySubscription = UNSAFE_withComponentProps(function OneDaySubscriptionPage() {
  ...
  return /* @__PURE__ */ jsx(Page, {
    ...
    children: /* @__PURE__ */ jsxs(Layout, {
      children: [fetcher.data && !isSubmitting && /* @__PURE__ */ jsx(Layout.Section, {
        children: /* @__PURE__ */ jsx(Banner, {
        ...
        children: /* @__PURE__ */ jsx(Card, {
          children: /* @__PURE__ */ jsxs(BlockStack, {
            ...
            children: [/* @__PURE__ */ jsx(InlineStack, {
              ...
              }), dailyPlanId2 && currentlyActive && /* @__PURE__ */ jsxs(InlineStack, {
                gap: "200",
                blockAlign: "center",
                children: [/* @__PURE__ */ jsx(Text, {
                  variant: "bodyMd",
