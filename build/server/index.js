...
const action$8 = async ({
  ...
  try {
    ...
    if (actionType === "trigger_billing_attempt") {
      ...
      const orderName = ((_g = attempt == null ? void 0 : attempt.order) == null ? void 0 : _g.name) || "";
      return {
        success: true,
