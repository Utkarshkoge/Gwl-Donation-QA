...
import { AppProvider as AppProvider$1, useIndexResourceState, IndexTable, Text, InlineStack, Button, Page, Layout, Banner, Box, List, Card, EmptyState, Badge, BlockStack, DescriptionList, Checkbox, Modal, Select, Icon } from "@shopify/polaris";
  ...
  return /* @__PURE__ */ jsxs(Page, {
    ...
    children: [/* @__PURE__ */ jsxs(Layout, {
              ...
              children: /* @__PURE__ */ jsxs(BlockStack, {
                ...
                children: [/* @__PURE__ */ jsxs(BlockStack, {
                  ...
                  children: [/* @__PURE__ */ jsx(Text, {
                    variant: "headingSm",
                    as: "h3",
                    children: "⚡ Manual Billing Attempt Execution"
                  }), /* @__PURE__ */ jsx(Text, {
                    as: "p",
                    tone: "subdued",
                    children: "Because Shopify executes background automatic billing in batch jobs periodically, changing the billing date won't trigger billing instantly. Use this button to force Shopify to perform an immediate billing attempt right now!"
                  })]
                  ...
                  children: /* @__PURE__ */ jsx(Button, {
                    ...
                    loading: isSubmitting2 && ((_h = fetcher.formData) == null ? void 0 : _h.get("_action")) === "trigger_billing_attempt",
                    disabled: isSubmitting2,
                    children: "🚀 Execute Billing Attempt Now"
                  })
                })]
              })
            })]
      ...
      primaryAction: {
        ...
        destructive: true,
        loading: isSubmitting2 && ((_i = fetcher.formData) == null ? void 0 : _i.get("_action")) === "cancel",
        onAction: () => {
          handleAction("cancel");
