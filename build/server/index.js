...
const action$8 = async ({
  ...
  try {
    ...
    if (actionType === "trigger_billing_attempt") {
      ...
      const billingAttemptId = (attempt == null ? void 0 : attempt.id) || `gid://shopify/SubscriptionBillingAttempt/${now.getTime()}`;
      let contractDetails = null;
      try {
