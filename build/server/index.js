...
const loader$l = async ({
  ...
  if (!donations.length) {
    ...
    const totalAmount = donations.filter((d) => d.status === "active").reduce((sum, d) => sum + d.donationAmount, 0);
    html += `
