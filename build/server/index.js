...
const loader$n = async ({
  ...
  if (!isProxyRequest) {
    ...
    if (id) {
      return redirect(`/app/subscription-detail?id=${id}&customer_id=${customerId2 || ""}`);
    }
